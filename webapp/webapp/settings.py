...
#dotenv. będzie chroniło nasze api, z grami i filmami w wydarzeniach
load_dotenv()
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Własny context processor pozwala pokazywać licznik zaproszeń w navbarze.
                'main.context_processors.pending_friend_requests',
            ],
        },
    },
]
